      ...
      <Container className="pt-md-5 p-2">
          ...
          <div>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr>
                  <th scope="row">
                    <p className="text-custom-grey mb-0"> Liquor & Beverage </p>
                  </th>
                  <td>
                    <p className="text-custom-grey mb-0">15 % Discount </p>
                  </td>
        ...
        <Col>
          <div>
            ...
            <p>
              <u>Swimming Pool & Fitness Centre Access:</u> Complimentary access to the
              swimming pool and state-of-the-art fitness center, complete with
              modern equipment and personalized trainers for a balanced wellness
              routine.
            </p>
            <p>
            <u>Unlimited Facility Access:</u> Access to facilities such as steam
              rooms, saunas, and relaxation lounges, providing serene spaces for
              unwinding.
            </p>
            <p>
            <u>Free Wellness Consultations:</u> Unlimited free wellness consultations
              with an Ayurveda doctor, covering topics like meditation, healthy
              living, and stress management.
            </p>
            <p>
            <u>Spa Services:</u> Enjoy a 60-minute signature spa treatment of your
              choice as package benefit & skilled therapists will customize each
              treatment to your specific needs. Members receive an exclusive
              15%to 25% discount on additional spa treatments and services
              beyond the signature treatment depending on the category.
            </p>
            <p>
            <u>Dining Discounts:</u> Enjoy a 15% to 20% discount on dining at the
              Lime Tree restaurant, offering exquisite cuisine in a stunning
            ...
            <p>
            <u>Preferred Booking:</u> Priority booking for appointments, ensuring
              preferred time slots for treatments and facilities.
            </p>
            <p>
            <u>Guest Passes:</u> Receive up to two guest passes per year, allowing
              you to share the spa experience with friends or family.
            </p>
          </div>
...
<div>
            ...
            <p>
            To become a Zuri Privilege Member, visit the spa reception desk or call the dedicated membership line at [phone number]. Friendly staff will guide you through the enrollment process.
            </p>

            <p className="py-3">
                <u>Limited Availability:</u>
            </p>
            <p>Please note that membership is limited to 50 members, ensuring an intimate and personalized experience.</p>
            <p>Indulge in self-care and well-being with the Zuri Privilege Member package, offering a tranquil oasis for relaxation and rejuvenation. Elevate your lifestyle and discover inner peace through this exclusive wellness journey.</p>
            </div>
        </Col>
      </Container>
    </>
