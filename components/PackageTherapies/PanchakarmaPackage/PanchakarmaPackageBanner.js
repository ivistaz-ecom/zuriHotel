...
const PanchakarmaPackageBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/offers/ayurvedha_panchakarma.jpg')`,
        height: 460,
    ...
    return (
        <Container className='custom-kumarkom-menu-container' style={{}}>
            ...
            <Col className='text-center pb-3'>
                <h3 className='text-custom-grey'>PANCHAKARMA PROGRAMME</h3>
            </Col>
...
export default PanchakarmaPackageBanner