...
const RejuvenationPackageContent = () => {
    return (
        <>
            <Container className='p-md-0 py-md-5 p-2'>
                ...
                <Col className='text-center'>
                    ...
                    <h6 className='text-decoration-underline text-black'>REJUVENATION PACKAGE</h6>
                    <p>
                        Rejuvenation – The term itself means “reversing the aging process” and this program aims at making one feel younger. This program includes treatments using herbal oils and therapies, which revitalizes and detoxifies your body thus purifying you and making you feel completely rejuvenated. This therapy helps to slow down the aging process. The major benefits of this treatment is to prolong life span, strengthen sense organs, improve memory, obtain perfect health, youthfulness and increased physical endurance.
                    </p>
                </Col>
...
export default RejuvenationPackageContent