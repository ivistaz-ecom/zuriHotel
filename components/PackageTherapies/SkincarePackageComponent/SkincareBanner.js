...
const RejuvenationPackageBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/offers/skincare_package.jpg')`,
        height: 460,
    ...
    return (
        <Container className='custom-kumarkom-menu-container' style={{}}>
            ...
            <Col className='text-center pb-3'>
                <h3 className='text-custom-grey'>SKIN CARE AND BEAUTY CARE PROGRAMME</h3>
            </Col>
...
export default RejuvenationPackageBanner