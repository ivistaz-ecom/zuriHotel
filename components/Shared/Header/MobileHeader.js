        ...
        >
          {/* {pathname !== "/christmas-new-year-offers" && (
            ...
            >
              <p className="mb-0 text-white">
                Make your Christmas and New Year's unforgettable. <br />
                <Link
          ...
          <Row className="d-flex flex-row flex-wrap justify-content-center align-items-center m-0">
            ...
            >
              ...
              <Col className="cusrom-make-reservation-btn">
            ...
            <Col className="d-flex flex-column justify-content-center align-items-center p-1">
              ...
              <Col className="text-center p-0 w-100 mt-3">
                <Link
                  ...
                  className="text-decoration-none text-black"
                >
                  <h6 className="mb-0 font11px">Contact Us</h6>
                </Link>
                <hr />
              </Col>
              ...
              <Col className="text-center p-0 w-100 mt-3">
                <Link
                  ...
                  className="text-decoration-none text-black"
                >
                  <h6 className="mb-0 font11px">Blog</h6>
                </Link>
              </Col>
            </Col>
          )}
            ...
            <Container className="d-flex flex-column d-md-none bg-white shadow-sm mt-3 z-3">
              <form onSubmit={handleFormSubmit}>
                <div className="d-flex flex-column gap-4">
                  <div className="d-flex flex-column gap-2">
                    <div>
                      <label htmlFor="hotel" className="text-black-50">
                        Hotels, City:
                      </label>
                    </div>
                    <div>
                      <select
                        ...
                        required
                        style={{
                          borderColor: hotelValidationError ? "red" : "",
                        }}
                      >
                  ...
                  <div className="d-flex flex-row gap-4">
                    <div className="d-flex flex-column gap-2">
                      <div>
                        <label htmlFor="rooms" className="text-black-50">
                          Rooms:
                        </label>
                      </div>
                      <div>
                    ...
                    <div className="d-flex flex-column gap-2">
                      <div>
                        <label htmlFor="adults" className="text-black-50">
                          Adults:
                        </label>
                      </div>
                      <div>
                    ...
                    <div className="d-flex flex-column gap-2">
                      <div>
                        <label htmlFor="children" className="text-black-50">
                          Children:
                        </label>
                      </div>
                      <div>
                  ...
                  <div className="d-flex flex-column gap-4">
                    <div className="text-center d-flex flex-column gap-2">
                      ...
                      <Link
                        ...
                        target="_blank"
                      >
                        <p className="text-black font12px">
              ...
              >
                ...
                <Col className="text-center">
                  <Col className="dimond-shap-close"></Col>
                </Col>
              </Col>
            </Container>
          )}
