    ...
    <>
      ...
      >
        ...
        {/* {pathname !== "/christmas-new-year-offers" && (
          ...
          >
            <p className="mb-0 text-white fs-6">
              ...
              <Link
                href="/christmas-new-year-offers"
                ...
                <Col className="d-flex flex-row align-items-start justify-content-end gap-4">
                  ...
                  <Col md={2}>
                    <div className="d-flex flex-row justify-content-end pe-4">
                      ...
                      >
                        <Image
                          src="/header/linked_in_final.svg"
                          alt=""
                          height={20}
                        />
                      </Link>
                    ...
                    <div className="d-flex flex-row">
                      <div>
                        <div className="px-4 py-4 after-header hover-to-show">
                          <h6 className=" mb-0 custom-header">Hotels</h6>
                        </div>

                        <Container fluid className="hotel-hidden z-1">
                          <Container className="position-relative">
                            <Col className="dimond-shap-1"></Col>
                      ...
                      <div>
                        <div className="px-4 py-4 after-header events">
                          <h6 className=" mb-0 custom-header">Events</h6>
                        </div>

                        <Container fluid className="events-hidden z-1">
                          <Container className="position-relative">
                            <Col className="dimond-shap-2"></Col>
                      ...
                      <div>
                        <div className="px-4 py-4 after-header offers">
                          <h6 className=" mb-0 custom-header">Offers</h6>
                        </div>

                        <Container fluid className="offers-hidden z-1">
                          <Container className="position-relative">
                            <Col className="dimond-shap-3"></Col>
                            <Col className="d-flex flex-row flex-wrap gap-4 nav-show">
                              <Link
                      ...
                      <div>
                        <div className="px-4 py-4 after-header mayaspa">
                          <h6 className=" mb-0 custom-header">Maya Spa</h6>
                        </div>

                        <Container fluid className="mayaspa-hidden z-1">
                          <Container className="position-relative">
                            <Col className="dimond-shap-4"></Col>
                            <Col className="d-flex flex-row flex-wrap gap-4 nav-show">
                              <Link
                      ...
                      <div className="px-4 py-4 after-header">
                        ...
                        >
                          <h6 className=" mb-0 header-font">Contact Us</h6>
                        </Link>
                      </div>
                      ...
                      <div className="px-4 py-4 after-header">
                        <Link
                          ...
                          className="text-decoration-none text-black"
                        >
                          <h6 className="mb-0  header-font">Blog</h6>
                        </Link>
                      </div>
                    </div>
                  </Col>
                    ...
                    <Col className="d-flex flex-column align-items-end justify-content-center p-0">
                      <Row className="d-flex flex-row flex-nowrap d-inline-block justify-content-center ">
                        <Col className="d-flex flex-row p-0">
                          ...
                          >
                            <Image
                              src="/header/search_icon_final.svg"
                              alt=""
                              height={15}
                            />
                          </button>
                        ...
                        >
                          <Col className="dimond-shap-purple"></Col>
        ...
        {searchTerm && searchResults.length > 0 && (
          <Container
            fluid
            className="search-results py-4 vh-50 overflow-scroll  shadow-lg"
          >
            <Container>
              <Row className="d-flex flex-lg-row flex-column">
                {searchResults.map((result) => (
                  <Col
                    lg={3}
                    key={result.id}
                    className="p-0 shadow-sm d-flex flex-column align-items-stretch"
                  >
                    <Col className="p-1">
                      <Col>
                        <Link
                      ...
                      <Col className="search-txt mt-2">
                        ...
                        >
                          <h6
                            className="text-black text-2line"
